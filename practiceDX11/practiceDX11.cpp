...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PRACTICEDX11));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   ::AdjustWindowRect(&windowRect,WS_OVERLAPPEDWINDOW,false);// 메뉴창 같은거 공간에 포함 안시키기.
